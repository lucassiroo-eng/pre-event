...
const CONFIGS: Record<CountryCode, CountryConfig> = {
  ...
  pt: { code: "pt", name: "Portugal", flag: "\u{1F1F5}\u{1F1F9}", hasMap: true, hue: 145, primary: "oklch(0.55 0.18 145)" },
  br: { code: "br", name: "Brasil", flag: "\u{1F1E7}\u{1F1F7}", hasMap: true, hue: 135, primary: "oklch(0.6 0.18 135)" },
  mx: { code: "mx", name: "México", flag: "\u{1F1F2}\u{1F1FD}", hasMap: true, hue: 160, primary: "oklch(0.55 0.15 160)" },
